        ...
        with torch.no_grad():
            ...
            for i_batch, sample_batched in enumerate(tbar):
                (
                    ...
                    predictions_global,
                    predictions_local,
                ) = evaluator.eval_test(sample_batched, model, global_fixed)
            ...
            if test:
                ...
                log = (
                    log
                    + "epoch [{}/{}] IoU: train = {:.4f}, val = {:.4f}".format(
                        epoch + 1,
                        num_epochs,
                ...
                log = (
                    log
                    + "epoch [{}/{}] Local  -- IoU: train = {:.4f}, val = {:.4f}".format(
                        epoch + 1,
                        num_epochs,
                ...
                log = (
                    log
                    + "epoch [{}/{}] Global -- IoU: train = {:.4f}, val = {:.4f}".format(
                        epoch + 1,
                        num_epochs,
